...
int main(){
    //dichiaro due variabili di tipo string e a parola gli assegno ciò che è scritto in msg.txt
    ...
    for(int i= 0; i<parola.size(); i++){
        ...
        //ogni conversione in binario di ogni lettera viene concatenata alla variabile bin, che conterrà l'intera conversine del messaggio
